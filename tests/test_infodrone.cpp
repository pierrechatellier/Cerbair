...
TEST_CASE("Full decode") {
    ...
    t.push_back(0x01); t.push_back(0x01); t.push_back(0x03);
    const std::string fr = "FR-30TEST";
    t.push_back(0x02); t.push_back(uint8_t(fr.size()));
    t.insert(t.end(), fr.begin(), fr.end());
    const std::string ansi = "1ABCDEF";
    t.push_back(0x03); t.push_back(uint8_t(ansi.size()));
    t.insert(t.end(), ansi.begin(), ansi.end());
    t.push_back(0x04); t.push_back(0x04); putI32(t, 4881350);
    t.push_back(0x05); t.push_back(0x04); putI32(t,  231520);
    t.push_back(0x06); t.push_back(0x02); putU16(t, 105);
    t.push_back(0x07); t.push_back(0x02); putU16(t,  30);
    t.push_back(0x08); t.push_back(0x04); putI32(t, 4881000);
    t.push_back(0x09); t.push_back(0x04); putI32(t,  231000);
    t.push_back(0x0A); t.push_back(0x02); putU16(t,  52);
    t.push_back(0x0B); t.push_back(0x02); putU16(t, 1234);
...
TEST_CASE("Missing fields: defaults, no crash") {
    std::vector<uint8_t> t;
    t.push_back(0x04); t.push_back(0x04); putI32(t, 0);
    auto f = infodrone::decode(makeIe(t));
    REQUIRE(f.version == 0);
